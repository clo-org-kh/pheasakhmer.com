...
var Cats;
(function (Cats) {
    Cats[Cats["Other"] = 0] = "Other";
    Cats[Cats["Base"] = 1] = "Base";
    Cats[Cats["Robat"] = 2] = "Robat";
    Cats[Cats["Coeng"] = 3] = "Coeng";
    Cats[Cats["ZFCoeng"] = 4] = "ZFCoeng";
    Cats[Cats["Shift"] = 5] = "Shift";
    Cats[Cats["Z"] = 6] = "Z";
    Cats[Cats["VPre"] = 7] = "VPre";
    Cats[Cats["VB"] = 8] = "VB";
    Cats[Cats["VA"] = 9] = "VA";
    Cats[Cats["VPost"] = 10] = "VPost";
    Cats[Cats["MS"] = 11] = "MS";
    Cats[Cats["MF"] = 12] = "MF";
})(Cats || (Cats = {}));
const categories = [
...
export function khtest(txt) {
    ...
    while (txt.length) {
        ...
        if (m) {
            ...
            txt = txt.substring(m.indices[1][1]); // update start to after this syllable
        ...
        if (m2 && m2.indices[1][1] > 1) {
            res.push(m2[1]); // yes then insert 25CC in output
            txt = txt.substring(m2.indices[1][1] - 1);
        }
        else {
...
//# sourceMappingURL=khnormal.js.map